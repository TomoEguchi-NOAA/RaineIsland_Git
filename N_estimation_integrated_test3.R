#N_estimation
# test3: Only seasons with both CMR and counts datasets are analyzed.
...
model.v.I <- 'v15'  # v15 seems to have the lowest gelman stats, still > 1.1
model.v.T <- 'v7'
model.v.P <- 'v2'
...
if (model.v.I == 'v12'){
  parameters.I <- c( 's', 'N', 'meanR', "TC_se",
                     "s_alpha", "s_beta",
                     "q", "q_se",
                     "q_beta0", "q_beta1",
                     "F_island", "deviance")
