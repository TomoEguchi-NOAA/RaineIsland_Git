...
modelName <- "models/Model_Petersen_Tally_AllYrs_v11.txt"
...
save(tally.list.3, LP.list,
     file = paste0('RData/N_estimaion_AllYrs_data_v11_',
                   run.date, '.RData'))

save(N.df, q.df, tmp, mv.sums,
     bugs.data, sum.tmp,
     file = paste0('RData/Petersen_Tally_AllYr_v11_Jags_out_',
                   run.date, '.RData'))
